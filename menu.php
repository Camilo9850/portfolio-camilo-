            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav me-auto mb-2 mb-md-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo $pagina == "proyectos" ? "active" : ""; ?> px-4" href="proyecto.php">Proyectos</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <ul class="navbar-nav">
                        <li class="float-sm-end">
                            <a class="btn btn-rojo" href="images/Hoja de vida 2025  25.pdf  ">Descargar mi CV <i
